 ...
 */
package phylodynamics.marsden;

import beast.base.inference.parameter.RealParameter;
import phylodynamics.epidemiology.HybridSEIREpidemic;
...
public class BDSIRLikelihoodDebugging {
    ...
    public static void main (String [] args) throws Exception {
        ...
        for (int traj=0; traj<nTraj; traj++) {
            sir.initTraj(new Double[]{0.005}, 0., new Double[]{2.0}, new Double[]{0.},0., 2.5, tree.getLeafNodeCount(), 100, 10001, sir.times,false);
