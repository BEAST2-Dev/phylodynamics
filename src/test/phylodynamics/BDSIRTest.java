...
public class BDSIRTest {
    ...
    public void testBDSIRLikelihood() throws Exception {
        ...
        BDSIRParameterization bdsirParam = new BDSIRParameterization();

        bdsirParam.initByName(
                "processLength", new RealParameter("15."),
                "Re", new SkylineVectorParameter(new RealParameter("7.5"), new RealParameter("2.5 2.5")),
        ...
        System.out.println("Scenario 1: logP: " + logP + " && logPtruth: ~ " + logPtruth);
        assert (Math.abs(logP - logPtruth) / Math.abs(0.5 * (logP + logPtruth)) < 1e-4);
    }

    @Test
    public void testBDSIRLikelihood2() throws Exception {
        //----------------------------------------Test 2(same tree as Test 1)------------------------------------------------------------
        ...
        // logP computed from BDSIR from phylodynamics version 1.5.0 based on bdsky version 1.5.1 for comparison during BEAST3 migration
        double logPtruth = -451.2857974679011;

        System.out.println("Scenario 2: logP: " + logP + " && logPtruth: ~ " + logPtruth);
        assert(Math.abs(logP-logPtruth)/Math.abs(0.5*(logP+logPtruth))<1e-4);
    }

    @Test
    public void testBDSIRLikelihood3() throws Exception {
        ...
        bdsirParam.initByName(
                "processLength", new RealParameter("30."),
                "Re", new SkylineVectorParameter(new RealParameter("15"), new RealParameter("2.5 2.5")),
                "becomeUninfectiousRate", new SkylineVectorParameter(null, new RealParameter("0.2")),
                "samplingProportion", new SkylineVectorParameter(null, new RealParameter("0.10")),
                "removalProb", new SkylineVectorParameter(null, new RealParameter("1.0")),
                "S0", new RealParameter("1000."),
        ...
        // logP computed from BDSIR from phylodynamics version 1.5.0 based on bdsky version 1.5.1 for comparison during BEAST3 migration
        double logPtruth = -157.40908231942964;

        System.out.println("Scenario 3: logP: " + logP + " && logPtruth: ~ " + logPtruth);
        assert (Math.abs(logP - logPtruth) / Math.abs(0.5 * (logP + logPtruth)) < 1e-4);
    }

    @Test
    public void testBDSIRLikelihood4() throws Exception {
        ...
        bdsirParam.initByName(
                "processLength", new RealParameter("30."),
                "Re", new SkylineVectorParameter(new RealParameter("15"), new RealParameter("5 5")),
                "becomeUninfectiousRate", new SkylineVectorParameter(null, new RealParameter("0.2")),
        ...
        // logP computed from BDSIR from phylodynamics version 1.5.0 based on bdsky version 1.5.1 for comparison during BEAST3 migration
        double logPtruth = -278.5405119276242;

        System.out.println("Scenario 4: logP: " + logP + " && logPtruth: ~ " + logPtruth);
        assert (Math.abs(logP - logPtruth) / Math.abs(0.5 * (logP + logPtruth)) < 1e-4);
    }

    @Test
    public void testBDSIRLikelihood5() throws Exception {
        ...
        bdsirParam.initByName(
                ...
                "Re", new SkylineVectorParameter(new RealParameter("25"), new RealParameter("1.5 1.5")),
                "becomeUninfectiousRate", new SkylineVectorParameter(null, new RealParameter("0.2")),
                "samplingProportion", new SkylineVectorParameter(null, new RealParameter("0.10")),
                "removalProb", new SkylineVectorParameter(null, new RealParameter("1.0")),
                "S0", new RealParameter("1000."),
        ...
        // logP computed from BDSIR from phylodynamics version 1.5.0 based on bdsky version 1.5.1 for comparison during BEAST3 migration
        double logPtruth = -132.03873262406228;

        System.out.println("Scenario 5: logP: " + logP + " && logPtruth: ~ " + logPtruth);
        assert (Math.abs(logP - logPtruth) / Math.abs(0.5 * (logP + logPtruth)) < 1e-4);
    }

    @Test
    public void testBDSIRLikelihood6() throws Exception {
        ...
        // logP computed from BDSIR from phylodynamics version 1.5.0 based on bdsky version 1.5.1 for comparison during BEAST3 migration
        double logPtruth = -146.82527511714437;

        System.out.println("Scenario 6: logP: " + logP + " && logPtruth: ~ " + logPtruth);
        assert(Math.abs(logP-logPtruth)/Math.abs(0.5*(logP+logPtruth))<1e-4);
    }
}
